 ...
 *						in pwm)_tmrctr.h.   No changes to this file other than rolling Version number
 *
 *
 * Description:
 * ============
...
XStatus PWM_SetParams(XTmrCtr *InstancePtr, Xuint32 freq, Xuint32 dutyfactor)
{
	...
	#ifdef Use_PmodCtlSys
		// lengthen the period to make the lamp less bright
		// this will keep the phototransistor from saturating
		// as quickly as it would if there was no correction
		tlr0 = ((pwm_period * 1.50) / plb_clock_period) - 2;
	#endif
